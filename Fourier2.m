%Application transformée de Fourier pour isoler une autre partie de l'image
...
%% seuil
Img_seuil = double(Img_contour(:,:)>45); % On seuil pour ne faire apparaitre que le champ
